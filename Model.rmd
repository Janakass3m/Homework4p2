...
The model ensemble consisted of 500 trees (ntree = 500), with each split considering approximately √(number of predictors) features (mtry = sqrt(p)), a common heuristic for classification.
...
The selected threshold was approximately 0.55, meaning that appointments with predicted probability ≥ threshold are classified as no-shows.
